...
export default function Stats() {
    return (
        <section className="flex mx-auto container flex-wrap md:flex-nowrap justify-between mt-12">
            <div className="w-1/2 md:w-auto gap-2 xl:gap-3 mb-8 md:mb-0 flex justify-center align-center">
            ...
            <div className="w-1/2 md:w-auto gap-2 xl:gap-3 flex justify-center align-center">
