...
export default function Header() {
    ...
    return (
        <header className="my-4 py-4 rounded-full xl:my-9 xl:py-3 container flex items-center justify-end md:justify-between">
            <Link className="group font-bold hidden md:block capitalize text-4xl" href="/"><h1>sayef<span className={`${currentPath == '/' && "text-accent"} group-hover:text-accent transition-all`}>.</span></h1></Link>
