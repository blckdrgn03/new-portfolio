...
export default function Header() {
    ...
    return (
        <header className={`transition-all duration-200 fixed top-1 -translate-x-1/2 z-10 left-1/2 text-white py-4 backdrop-blur-lg rounded-full xl:my-9 xl:py-3 container flex items-center justify-end md:justify-between ${isVisible ? "" : "-translate-y-[10rem]"} ${isScrolled ? "border border-white/[0.1] shadow-2xl" : ""}`}>
