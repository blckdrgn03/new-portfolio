...
export default function Socials() {
    return (
        <div className="flex justify-center xl:justify-start items-center gap-8 xl:gap-12">
            <Button className="bg-accent cursor-disabled text-sm lg:text-md font-semibold xl:p-6 xl:text-lg text-primary rounded-full hover:bg-accent-hover">Download Resume</Button>
