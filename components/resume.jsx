                    ...
                    <div className="">
                        ...
                        <div className="flex flex-wrap gap-3 md:gap-4">
                            {aboutData.map((data, i) => {
                                return (
                                    <div key={i} className={`   rounded-[8px] px-1 py-3 border border-1 shadow-xl bg-accent/[0.05] transition-all duration-300 hover:bg-accent/[0.1] border-accent/[0.25] ${(data[0] == "Name" || data[0] == "Email") ? "w-full md:w-[calc(50%-8px)]" : "w-[calc(50%-6px)] md:w-[calc(50%-8px)]" }`}>
                ...
                <TabsContent value="education">
                    <div className="">
                        ...
                        <div className="flex flex-col flex-wrap gap-3 md:gap-4">
                            <div className="rounded-[8px] py-3 border border-1 shadow-xl px-1 bg-accent/[0.05] transition-all duration-300 hover:bg-accent/[0.1] border-accent/[0.25] px-2 ">
                                <h3 className="text-md text-white  text-center md:text-lg lg:text-xl">School (BCPSC)</h3>
                                <p className=" text-center">2014-Present</p>
                            </div>
                            <div className="rounded-[8px] py-3 border border-1 shadow-xl bg-accent/[0.05] transition-all duration-300 hover:bg-accent/[0.1] border-accent/[0.25] px-1 ">
                                <h3 className="text-md text-white text-center md:text-lg lg:text-xl">
                                Codecademy</h3>
                                <p className=" text-center">2022-2024</p>
                            </div>
                            <div className="rounded-[8px] py-3 border border-1 border-accent/[0.25] shadow-xl bg-accent/[0.05] transition-all duration-300 hover:bg-accent/[0.1] px-1 ">
...
function Technology({ tech }) {
    return (
        <div className="w-full md:w-[calc(50%-8px)] p-3 bg-accent/[0.05] rounded-[8px] border border-1 border-accent/[0.25] shadow-xl hover:bg-accent/[0.1] justify-between transition-all duration-300 flex items-center">
